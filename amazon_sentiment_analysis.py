...
for i in range(1,100):
  ip=[]  
  url="https://www.amazon.in/Redmi-Note-Neptune-Blue-Storage/product-reviews/B07X1KT6LD/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber="+str(i)
...
with open("redmi_neptune.txt","w",encoding='utf8') as output:
